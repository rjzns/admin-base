...
Процедура СопоставитьОбработкиКонфигурацииСОбработкамиСправочника(ОтчетыИОбработки)
	...
	Пока ОбратныйИндекс > 0 Цикл
		...
		Если ВерсияЧислом(ДанныеИзСправочника.Версия) = ВерсияЧислом(СтрокаТаблицы.Сведения.Версия) Тогда
...
Функция ЗарегистрироватьОбработку(Знач Объект, Знач ПараметрыРегистрации) Экспорт
	...
	//Карязов
	//Это нужно только для внутренних обработок
	//Для тех которые должны в другие базы уйти не нужно выполнять
